...
```bash
git clone https://github.com/winsonwq/openclaw-skill-evolution.git /path/to/openclaw-skill-evolution
openclaw plugins install /path/to/openclaw-skill-evolution
openclaw gateway restart
```
